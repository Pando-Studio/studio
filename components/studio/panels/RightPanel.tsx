...
const quickGenerateConfig: Record<GenerationType, {
  ...
  VIDEO: { templateId: 'qiplim/video-slideshow', defaultInputs: { slideCount: 8, targetDuration: '3', tone: 'professional', includeSlideImages: false, imageProvider: 'gemini' }, defaultTitle: 'Video', requiresModal: true },
};
